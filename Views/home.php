...
$view_tweets = [
    ...
    [
        ...
        'tweet_created_at' => '2021-12-14 14:00:00',
        'like_id' => 1,
        'like_count' => 1,
    ]
];
        ...
        <div class="side">
            <div class="side-inner">
                <ul class="nav flex-column">
                    <li class="nav-item"><a href="home.php" class="nav-link"><img src="<?php echo HOME_URL;?>Views/img/logo-twitterblue.svg" class="icon" alt=""></a></li>
                    ...
                    <li class="nav-item"><a href="post.php" class="nav-link"><img src="<?php echo HOME_URL;?>Views/img/icon-post-tweet-twitterblue.svg" class="post-tweet" alt=""></a></li>
        ...
        <?php else : ?>
            ...
            <div class="tweet-list">
                <?php foreach($view_tweets as $view_tweet) : ?>
                    ...
                    <div class="tweet">
                        <div class="user">
                            <a href="profile.php?_id=<?php echo htmlspecialchars($view_tweet['user_id']); ?>">
                        ...
                        <div class="content">
                            <div class="name">
                                <a href="profile.php?user_id=<?php echo htmlspecialchars($view_tweet['user_id']); ?>">
                                    <div class="nickname"><?php echo htmlspecialchars($view_tweet['user_nickname']); ?></div>
